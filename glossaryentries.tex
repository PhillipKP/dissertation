...
\newglossaryentry{H}{type=symbols,name={$ \mathbf{ H } $}, symbol={$ \mathbf{ H } $}, sort=H, description={The system matrix which captures all of the physical phenomena in a measurement. Also called the measurement matrix and sensing matrix.}}
...
\newglossaryentry{spectralDataCube}{type=symbols,name={ $\bf{\mathcal{F}}$ }, symbol={ $\bf{\mathcal{F}}$ }, sort=F, description={Notation for the spectral datacube. }}
