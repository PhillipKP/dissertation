...
\documentclass[dissertation,CC]{uathesis}
...
% Formats chapter and section titles
\usepackage{titlesec}
...
% Use these packages for formatting algorithms
...
% Adds any glossaries, list of acronyms, list of symbols we want to the table of contents
\glstoctrue
...
% Custom command to create paraenthesis that auto size anything you put in the argument of this command
...
{Michael E. Gehm}	% 2nd committee member
{Rongguang Liang}	% 3rd committee member
...
\begin{appendices}
	...
	\include{scoutExpPsuedoCode}
	\include{scoutSimCode}
	\include{apLogLikelihood}
